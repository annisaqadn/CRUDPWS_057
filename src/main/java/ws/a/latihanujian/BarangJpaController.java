...
import ws.a.latihanujian.exceptions.NonexistentEntityException;
import ws.a.latihanujian.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_latihanujian_jar_0.0.1-SNAPSHOTPU");
